...
ActiveRecord::Schema.define(version: 2024_08_05_195715) do
  ...
  create_table "issue_histories", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["fieldChange_id"], name: "index_issue_histories_on_fieldChange_id"
  ...
  add_foreign_key "issue_histories", "field_changes", column: "fieldChange_id"
